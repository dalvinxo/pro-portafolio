...
const Project = ({ proyect }: { proyect: TypeProyects }) => {
  ...
  return (
    <Fragment>
      <li className="my-5 px-2 flex xs:flex-col justify-between items-center py-3 xs:py-1 rounded-md shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5 dark:hover:bg-slate-900/10 hover:bg-gray-200">
